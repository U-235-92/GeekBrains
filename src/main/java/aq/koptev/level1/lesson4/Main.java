...
public class Main {
    ...
    private static final String WINNER_HUMAN_MSG = "�����������! �� ��������!";
    private static final String WINNER_COMPUTER_MSG = "������� ���������!";
    private static final String REPLAY_MSG = "������� ��� ���? Y/N";
    private static final String HORIZONTAL_ENTER_MSG = "������� ����� �������������� ������: ";
    private static final String VERTICAL_ENTER_MSG = "������� ����� ������������ ������: ";
    private static final String SIZE_GAME_MAP_MSG = "������� ������ �������� ���� (������ ������ ��� ����� 3): ";
    private static final String WRONG_FORMAT_MSG = "�������� ������ ��������� ������!";
    private static final String RECOMMEND_FORMAT_SIZE_GAME_MAP_MSG = "������� ������������� ����� �����, ������ ���� � ������ ���� ������ ";
    ...
    private static void humanStep() {
        ...
        while(true) {
            ...
            if(!isValidCell(xHuman, yHuman)) {
                ...
                System.out.println("������ � ������������ [" + (xHuman + 1) + ": " + (yHuman + 1) + "] + ��� ������!" );
            } else {
